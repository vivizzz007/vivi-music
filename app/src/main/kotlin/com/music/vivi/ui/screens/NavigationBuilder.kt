...
import com.music.vivi.accountscreen.AccountviviSettings
...
import com.music.vivi.ui.screens.BrowseScreen
...
fun NavGraphBuilder.navigationBuilder(
    ...
    composable("account_settings") { backStackEntry ->
        AccountviviSettings(
            navController = navController,
            onClose = { navController.popBackStack() },
            latestVersionName = latestVersionName // You'll need to pass this from somewhere
        )
    }
