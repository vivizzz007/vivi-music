...
object YouTube {
                        ...
                        response.contents?.tabbedSearchResultsRenderer?.tabs?.firstOrNull()
                                ...
                                ?.mapNotNull { it ->
                                    if (it.musicCardShelfRenderer != null) {
                                        SearchSummary(
                                                title =
                                                        it.musicCardShelfRenderer.header
                                                                ...
                                                                ?.title?.runs?.firstOrNull()
                                                                ?.text
                                                                ?: "Top result",
                                                items =
                                                        listOfNotNull(
                                                                        SearchSummaryPage
                                                                                .fromMusicCardShelfRenderer(
                                                                ...
                                                                .plus(
                                                                        it.musicCardShelfRenderer
                                                                                ...
                                                                                ?.mapNotNull(
                                                                                        SearchSummaryPage
                                                                                                .Companion::fromMusicResponsiveListItemRenderer
                                                                                )
                                                                                .orEmpty()
                                                                )
                                                                .distinctBy { it.id }
                                        ...
                                        SearchSummary(
                                                title =
                                                        it.musicShelfRenderer?.title?.runs
                                                                ?.firstOrNull()
                                                                ?.text
                                                                ?: "Other",
                                                items =
    ...
    suspend fun album(browseId: String, withSongs: Boolean = true): Result<AlbumPage> =
            runCatching {
                ...
                if (browseId.contains("FEmusic_library_privately_owned_release_detail")) {
                    val playlistId =
                            response.header?.musicDetailHeaderRenderer?.menu?.menuRenderer
                                    ?.topLevelButtons?.firstOrNull()
                                    ?.buttonRenderer
                                    ?.navigationEndpoint
                            ...
                            AlbumItem(
                                    ...
                                    thumbnail =
                                            response.header.musicDetailHeaderRenderer.thumbnail
                                                            ...
                                                            ?.thumbnail?.thumbnails?.lastOrNull()!!
                                                    .url,
                                    explicit = false // TODO: Extract explicit badge for albums from
                                    // YouTube response
                                    )
                    ...
                    return@runCatching AlbumPage(
                            ...
                            otherVersions =
                                    response.contents
                                            ...
                                            ?.contents
                                            ?.find {
                                                it.musicCarouselShelfRenderer?.header
                                                        ?.musicCarouselShelfBasicHeaderRenderer
                                                        ?.title?.runs?.any {
                                                    it.text.contains("versions", ignoreCase = true)
                                                } == true
                                            }
                                            ...
                                            ?.mapNotNull(
                                                    NewReleaseAlbumPage::fromMusicTwoRowItemRenderer
                                            )
                                            .orEmpty(),
                            releasesForYou =
                                    response.contents
    ...
    suspend fun albumSongs(playlistId: String, album: AlbumItem? = null): Result<List<SongItem>> =
            runCatching {
                ...
                while (continuation != null && requestCount < maxRequests) {
                    ...
                    response =
                            innerTube
                                    .browse(client = WEB_REMIX, continuation = continuation)
                                    .body<BrowseResponse>()
                    songs +=
    ...
    suspend fun artist(browseId: String): Result<ArtistPage> = runCatching {
        ...
        val descriptionRuns =
                response.contents
                        ...
                        ?.runs
                        ?.let(::mapRuns)
                        ?: response.header?.musicImmersiveHeaderRenderer?.description?.runs?.let(
                                ::mapRuns
                        )
        ...
        ArtistPage(
                artist =
                        ArtistItem(
                                id = browseId,
                                title =
                                        response.header?.musicImmersiveHeaderRenderer?.title?.runs
                                                ?.firstOrNull()
                                                ?.text
                                                ?: response.header?.musicVisualHeaderRenderer?.title
                                                        ?.runs?.firstOrNull()
                                                        ?.text
                                ...
                                thumbnail =
                                        response.header?.musicImmersiveHeaderRenderer?.thumbnail
                                                ...
                                                ?: response.header?.musicVisualHeaderRenderer
                                                        ...
                                                        ?.musicThumbnailRenderer?.getThumbnailUrl()
                                                        ?: response.header
                                                        ?.musicDetailHeaderRenderer?.thumbnail
                                                        ?.musicThumbnailRenderer?.getThumbnailUrl(),
                                channelId =
                                        response.header
                                ...
                                subscriberCountText =
                                        response.header?.musicImmersiveHeaderRenderer
                                                ...
                                                ?: response.header?.musicImmersiveHeaderRenderer
                                                        ...
                                                        ?.subscriptionButton
                                                        ?.subscribeButtonRenderer
                                                        ?.subscriberCountText?.runs?.firstOrNull()
                                                        ?.text
                        ),
                sections =
                        response.contents
                ...
                monthlyListenerCount =
                        response.header?.musicImmersiveHeaderRenderer?.monthlyListenerCount?.runs
                                ?.firstOrNull()
                                ?.text,
    ...
    suspend fun artistItems(endpoint: BrowseEndpoint): Result<ArtistItemsPage> = runCatching {
        val response =
                innerTube
                        .browse(WEB_REMIX, endpoint.browseId, endpoint.params)
                        .body<BrowseResponse>()
        val gridRenderer =
                response.contents
                        ?.singleColumnBrowseResultsRenderer
        ...
        if (gridRenderer != null) {
            ...
            ArtistItemsPage(
                    title =
                            response.header?.musicHeaderRenderer?.title?.runs?.firstOrNull()
                                    ?.text!!,
                    items =
            ...
            runCatching {
                ...
                when {
                    ...
                    response.continuationContents?.musicPlaylistShelfContinuation != null -> {
                        ...
                        ArtistItemsContinuationPage(
                                items =
                                        musicPlaylistShelfContinuation.contents.getItems()
                                                .mapNotNull {
                                                    ArtistItemsPage
                        ...
                        val continuationItems =
                                response.onResponseReceivedActions?.firstOrNull()
                                        ?.appendContinuationItemsAction
                                        ?.continuationItems
                        ArtistItemsContinuationPage(
                                items =
            ...
            contents
                    .mapNotNull { content ->
                        content.musicCarouselShelfRenderer?.let { renderer ->
                            renderer.contents.mapNotNull { it.musicTwoRowItemRenderer }.mapNotNull {
    ...
    suspend fun playlistContinuation(continuation: String): Result<PlaylistContinuationPage> =
            runCatching {
                ...
                val mainContents: List<MusicShelfRenderer.Content> =
                        response.continuationContents?.sectionListContinuation?.contents?.flatMap {
                                content ->
                ...
                val songs =
                        allContents.mapNotNull { it.musicResponsiveListItemRenderer }.mapNotNull {
                            PlaylistPage.fromMusicResponsiveListItemRenderer(it)
                        }
        ...
        ExplorePage(
                ...
                moodAndGenres =
                        response.contents
                                ...
                                ?.mapNotNull(
                                        MoodAndGenres.Companion::fromMusicNavigationButtonRenderer
                                )
                                .orEmpty()
        )
    }
    ...
    suspend fun moodAndGenres(): Result<List<MoodAndGenres>> = runCatching {
        val response =
                innerTube
                        .browse(WEB_REMIX, browseId = "FEmusic_moods_and_genres")
                        .body<BrowseResponse>()
        response.contents?.singleColumnBrowseResultsRenderer?.tabs?.firstOrNull()
                        ?.tabRenderer
                        ?.content
                                            ...
                                            BrowseResult.Item(
                                                    ...
                                                    items =
                                                            content.gridRenderer
                                                                    ...
                                                                    .mapNotNull(
                                                                            RelatedPage
                                                                                    .Companion::fromMusicTwoRowItemRenderer
                                                                    )
                                            )
                                        }
    ...
    suspend fun library(browseId: String, tabIndex: Int = 0) = runCatching {
        ...
        when {
            contents?.gridRenderer != null -> {
                LibraryPage(
                        items =
                                contents.gridRenderer.items.mapNotNull(
                                                GridRenderer.Item::musicTwoRowItemRenderer
                                        )
                ...
                LibraryPage(
                        items =
                                contents?.musicShelfRenderer?.contents!!.mapNotNull(
                                                MusicShelfRenderer
                                                        .Content::musicResponsiveListItemRenderer
                                        )
                                        .mapNotNull {
                                            LibraryPage.fromMusicResponsiveListItemRenderer(it)
                                        },
        ...
        when {
            contents?.gridContinuation != null -> {
                LibraryContinuationPage(
                        items =
                                contents.gridContinuation.items.mapNotNull(
                                                GridRenderer.Item::musicTwoRowItemRenderer
                                        )
                                        .mapNotNull { LibraryPage.fromMusicTwoRowItemRenderer(it) },
                ...
                LibraryContinuationPage(
                        items =
                                contents?.musicShelfContinuation?.contents!!.mapNotNull(
                                                MusicShelfRenderer
                                                        .Content::musicResponsiveListItemRenderer
                                        )
                                        .mapNotNull {
    ...
    suspend fun libraryRecentActivity(): Result<LibraryPage> = runCatching {
        ...
        val items =
                response.continuationContents?.sectionListContinuation?.contents?.firstOrNull()
                                ?.gridRenderer
                                ?.items!!
                        .mapNotNull {
                            it.musicTwoRowItemRenderer?.let { renderer ->
    ...
    suspend fun getChartsPage(continuation: String? = null): Result<ChartsPage> = runCatching {
        ...
        response.contents?.singleColumnBrowseResultsRenderer?.tabs?.firstOrNull()
                ...
                ?.forEach { content ->
                    content.musicCarouselShelfRenderer?.let { renderer ->
                        val title =
                                renderer.header?.musicCarouselShelfBasicHeaderRenderer?.title?.runs
                                        ?.firstOrNull()
                                        ?.text
                                        ?: return@forEach
                    ...
                    content.gridRenderer?.let { renderer ->
                        val title =
                                renderer.header?.gridHeaderRenderer?.title?.runs?.firstOrNull()
                                        ?.text
                                        ?: return@let
            ...
            when {
                renderer.flexColumns.size >= 3 && renderer.playlistItemData?.videoId != null -> {
                    ...
                    SongItem(
                            ...
                            explicit =
                                    renderer.badges?.any {
                                        it.musicInlineBadgeRenderer?.icon?.iconType ==
    ...
    suspend fun uploadCustomThumbnailLink(playlistId: String, image: ByteArray) = runCatching {
        val uploadUrl =
                innerTube.getUploadCustomThumbnailLink(WEB_REMIX, image.size).headers[
                        "x-guploader-uploadid"]
        val blobReq = innerTube.uploadCustomThumbnail(WEB_REMIX, uploadUrl!!, image)
        val blobId =
                Json.decodeFromString<ImageUploadResponse>(blobReq.bodyAsText()).encryptedBlobId
        innerTube
            ...
            runCatching {
                ...
                val playlistPanelRenderer =
                        response.continuationContents?.playlistPanelContinuation
                                ?: response.contents.singleColumnMusicWatchNextResultsRenderer
                                        ?.tabbedRenderer?.watchNextTabbedResultsRenderer?.tabs?.get(
                                                0
                                        )
                                        ?.tabRenderer
                                        ?.content
                ...
                val items =
                        playlistPanelRenderer.contents.mapNotNull { content ->
                            content.playlistPanelVideoRenderer?.let(
                                            NextPage::fromPlaylistPanelVideoRenderer
                                    )
                ...
                // load automix items
                playlistPanelRenderer.contents.lastOrNull()
    ...
    suspend fun visitorData(): Result<String> = runCatching {
        Json.parseToJsonElement(innerTube.getSwJsData().bodyAsText().substring(5)).jsonArray[0]
                        .jsonArray[2]
                .jsonArray
                .first {
    ...
    suspend fun accountInfo(): Result<AccountInfo> = runCatching {
        ...
        val renderer =
                response.actions.getOrNull(0)?.openPopupAction?.popup?.multiPageMenuRenderer
